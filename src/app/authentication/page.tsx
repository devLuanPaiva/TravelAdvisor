    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-black">
      <div className="bg-white rounded-2xl shadow-xl p-10 w-full max-w-sm text-center">
        <h1 className="text-2xl font-bold mb-6 text-gray-900">
          Bem-vindo ao Travel Advisor!
        </h1>
        <p className="text-gray-600 mb-6">Entre com sua conta do Google</p>
        <button
          onClick={() => signIn("google", { callbackUrl: "/home" })}
          className="flex items-center justify-center gap-2 w-full py-3 px-4 rounded-lg bg-red-500 hover:bg-red-600 text-white font-medium transition duration-300 cursor-pointer"
        >
          <svg
            className="w-5 h-5"
            viewBox="0 0 24 24"
