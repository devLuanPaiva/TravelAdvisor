...
export function PlacesSidebar({ places, selectedType, setSelectedType, isShowSidebar, session }: Readonly<PlacesSidebarProps>) {
    ...
    return (
        <aside
            className={`relative w-1/4 h-full bg-gradient-to-b from-gray-900 via-gray-800 to-black text-white overflow-y-auto border-r border-gray-700 transition-all duration-300 ease-in-out ${isShowSidebar ? 'block' : 'hidden'
                }`}
        >
            ...
            <h3 className="text-lg font-semibold mb-3 text-gray-100 p-4">Resultados próximos</h3>
